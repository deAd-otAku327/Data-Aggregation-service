...
type Repository interface {
	...
	// ListSubscriptions(ctx context.Context, filters *models.SubscriptionFilterParams) ([]*models.Subscription, error)
	// GetTotalCost(ctx context.Context, periodStart, periodEnd time.Time, filters *models.SubscriptionFilterParams) (int, error)
}
